            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                      ...
                      <h2><span class="dot"></span> Trending Dell Laptops</h2>
                    </div>
                    <div class="">
...
import ProductItem from '../components/landing-one/ProductItem';
  export default {
    ...
    head () {
    return {
      title: 'Best Dell laptops 2021',
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        { hid: 'description', name: 'description', content: 'The collection of Dell laptops' },
        { hid: 'robots', name: 'robots', content: 'index,follow' }
      ],
      link: [
 {rel: 'canonical', href: 'https://laptops.ninja/dell' }
]
    }
  },
  data() {
