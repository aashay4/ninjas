                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="blog-details">
                            ...
                            <div class="article-content">
                                ...
                                <h1>Best laptops for students</h1>
                                ...
                                <h2>Best laptops for Students</h2>
                                <p>
                              <h3>Dell XPS 13</h3>
                                <p>Released in 2020, Dell XPS 13 is receiving some great reviews from the students. With attractive looks, outstanding performance, and excellent battery life, Dell XPS 13 is one of the best laptops for college students. It is a lightweight laptop that can easily be carried by the student. With the 10th generation intel core i7 processor, it is perfect for multi-tasks. A comfortable keyboard and near-bezel-less display make it perfect to work on this laptop for hours. If you are looking for the perfect laptop for college students, then this laptop is definitely for you.</p>
                                <a
                                  ...
                                  <h3>Lenovo Yoga C940</h3>
                                    ...
                                    <h3>Asus Zenbook 13</h3>
                                      ...
                                      <h3>Apple MacBook Air</h3>
                                        <p>There is a different community that prefers MacBook laptops, this one is for them. It is one of the best 13-in laptops with professional looks. Unsurprisingly, Apple MacBook offers one of the best battery life. You can work for hours on this laptop and perform absolutely any task. A great sound system is a plus of this laptop.</p>
                                        <p>Apple Macbook air offers a comfortable keyboard, which can be a great experience if you need to work for hours on your project or you are programming. Sometimes, performance can be an issue with this laptop. This machine is perfect for macOS lovers.</p>
                                        <a
...
export default{
  ...
  return {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Best laptops for students. This list of laptops is for students of college, high schools, and learners.' },
      { hid: 'robots', name: 'robots', content: 'index,follow' }
    ],
    link: [
{rel: 'canonical', href: 'https://laptops.ninja/laptops-for-students' }
]
  }
},
data() {
