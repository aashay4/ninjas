                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                          ...
                          <section class="products-collections-area ptb-60" ref="porto">
                            ...
                            <h2><span class="dot"></span> Select Acer Laptop</h2>
                          </div>
                              <div class="container">
                                  <div class="row">
...
import ProductItem from '../components/landing-one/ProductItem';
  export default {
    ...
    head () {
    return {
      title: 'Best Acer laptops 2021',
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        { hid: 'description', name: 'description', content: 'The collection of Acer laptops' },
        { hid: 'robots', name: 'robots', content: 'index,follow' }
      ],
      link: [
 {rel: 'canonical', href: 'https://laptops.ninja/acer' }
]
    }
  },
  data() {
