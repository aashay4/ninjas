            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                      ...
                      <h2><span class="dot"></span> Top General-purpose laptops</h2>
                    </div>
                    <div class="">
...
import ProductItem from '../components/landing-one/ProductItem';
  export default {
    ...
    head () {
    return {
      title: 'General purpose laptops',
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        { hid: 'description', name: 'description', content: 'General purpose laptops' },
        { hid: 'robots', name: 'robots', content: 'index,follow' }
      ],
      link: [
 {rel: 'canonical', href: 'https://laptops.ninja/general-purpose-laptops' }
]
    }
  },
  data() {
