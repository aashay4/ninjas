...
import nuxt_plugin_bootstrapvue_ed527cdc from 'nuxt_plugin_bootstrapvue_ed527cdc' // Source: .\\bootstrap-vue.js (mode: 'all')
import nuxt_plugin_axios_b6c6133a from 'nuxt_plugin_axios_b6c6133a' // Source: .\\axios.js (mode: 'all')
import nuxt_plugin_adsbygoogle_33524719 from 'nuxt_plugin_adsbygoogle_33524719' // Source: .\\adsbygoogle.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"htmlAttrs":{"lang":"en"},"title":"","meta":[{"name":"robots","content":"noindex,noarchive,nofollow"},{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Bolster is a clean and modern purse Vue Nuxt.js eCommerce template. This is built on Vue.js, Nuxt.js, Vuex, Firebase, Sass and Bootstrap 4. Bolster has included with an easy checkout feature. It has responsive beautiful design layouts with amazing Retina Ready visual UX\u002F UI experience."},{"hid":"robots","name":"robots","content":"noindex,nofollow"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[{"hid":"adsbygoogle-script","defer":true,"crossorigin":"anonymous","src":"\u002F\u002Fpagead2.googlesyndication.com\u002Fpagead\u002Fjs\u002Fadsbygoogle.js?client=ca-google"},{"hid":"adsbygoogle","innerHTML":"if (!window.__abg_called){ (adsbygoogle=window.adsbygoogle||[]).pauseAdRequests=0;\n         (window.adsbygoogle = window.adsbygoogle || []).push({\n    google_ad_client: \"ca-google\",\n    enable_page_level_ads: false,\n    overlays: {bottom: false}\n  }); window.__abg_called = true;}"}],"__dangerouslyDisableSanitizersByTagID":{"adsbygoogle":["innerHTML"]}},
  ...
  if (typeof nuxt_plugin_bootstrapvue_ed527cdc === 'function') {
    await nuxt_plugin_bootstrapvue_ed527cdc(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_b6c6133a === 'function') {
    await nuxt_plugin_axios_b6c6133a(app.context, inject)
  }

  if (typeof nuxt_plugin_adsbygoogle_33524719 === 'function') {
    await nuxt_plugin_adsbygoogle_33524719(app.context, inject)
  }
